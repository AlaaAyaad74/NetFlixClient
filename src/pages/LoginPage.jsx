      ...
      <div className="overlay">
        <div className="login-container">
          ...
          <form onSubmit={handleSubmit} className="login-form">
            ...
            />
            {emailError && <p className="error-message">{emailError}</p>} {/* Display email validation error */}
          ...
          <div className="login-options">
            ...
            <div className="login-new">
              New to the app? <Link to="/register" className="signup-now">Sign up now.</Link> {/* Use Link for navigation */}
            </div>
          </div>
        </div>
      </div>
